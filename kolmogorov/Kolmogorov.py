...
class Kolmogorov(object):
    ...
    def kolmogorov_ingredient(self, ingredient):
        return floor((log2((ingredient.local_availability_period[1]-ingredient.local_availability_period[0])/365) - log2(1/365))/coefs.normalization_kolmogorov_ingredient)
